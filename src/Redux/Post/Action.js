...
export const allPostsAction = (data) => async (dispatch) => {
    try {
        const res = await fetch(`${BASE_API}/posts/max/post`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                Authorization: "Bearer " + data.jwt
...
export const reqUserPostAction = (data) => async (dispatch) => {
    try {
        console.log("reqUserPostAction", data)
