import { Stack, FormLabel, FormControl, Input, useDisclosure, FormHelperText, Button } from '@chakra-ui/react'
                ...
                <Stack spacing="6">
                    <FormControl className='flex' id='name'>
                        ...
                        <div className='w-full'>
                            ...
                            <FormHelperText className='text-xs'>
                                Help people discover your account by using the name of you'er known
                                by: either your full name ,nickname or business name.
                            </FormHelperText>
                            <FormHelperText className='text-xs'>
                                You can only change name twice within 14 days.
                            </FormHelperText>
                        </div>
                    </FormControl>
                    <FormControl className='flex' id='username'>
                        ...
                        <div className='w-full'>
                            ...
                            <FormHelperText className='text-xs'>
                                In most cases,you will be able to change your username multiple times. Learn more
                            </FormHelperText>
                        </div>
                    </FormControl>
